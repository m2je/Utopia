...
public class SMTPBodyParameterHandler extends AbstractSMTPParatemterHandler implements ParameterHandler {

	
	public SMTPBodyParameterHandler(BeanProcessParameter[] parameters,
