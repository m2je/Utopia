 ...
 */
@MappedSuperclass
public abstract class AbstractCmFiscalyear extends AbstractUtopiaPersistent implements java.io.Serializable {


	private static final long serialVersionUID = -813489415467606059L;
	...
	@GeneratedValue(strategy=GenerationType.TABLE,
			generator="FiscalYearSequenceGenerator")
