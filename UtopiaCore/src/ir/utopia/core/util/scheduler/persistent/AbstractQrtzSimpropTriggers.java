...
/**
 * AbstractQrtzSimpropTriggers entity provides the base persistence definition
 * of the QrtzSimpropTriggers entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractQrtzSimpropTriggers implements
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5436323945070019338L;
	...
	/** default constructor */
	public AbstractQrtzSimpropTriggers() {
	}

	/** minimal constructor */
	public AbstractQrtzSimpropTriggers(QrtzSimpropTriggersId id,
	...
	@Column(name = "STR_PROP_1", unique = false, nullable = true, insertable = true, updatable = true, length = 512)
	...
	@Column(name = "STR_PROP_2", unique = false, nullable = true, insertable = true, updatable = true, length = 512)
	...
	@Column(name = "STR_PROP_3", unique = false, nullable = true, insertable = true, updatable = true, length = 512)
	...
	@Column(name = "INT_PROP_1", unique = false, nullable = true, insertable = true, updatable = true, precision = 10, scale = 0)
	...
	@Column(name = "INT_PROP_2", unique = false, nullable = true, insertable = true, updatable = true, precision = 10, scale = 0)
	...
	@Column(name = "LONG_PROP_1", unique = false, nullable = true, insertable = true, updatable = true, precision = 13, scale = 0)
	...
	@Column(name = "LONG_PROP_2", unique = false, nullable = true, insertable = true, updatable = true, precision = 13, scale = 0)
	...
	@Column(name = "DEC_PROP_1", unique = false, nullable = true, insertable = true, updatable = true, precision = 13, scale = 4)
	...
	@Column(name = "DEC_PROP_2", unique = false, nullable = true, insertable = true, updatable = true, precision = 13, scale = 4)
	...
	@Column(name = "BOOL_PROP_1", unique = false, nullable = true, insertable = true, updatable = true, length = 1)
	...
	@Column(name = "BOOL_PROP_2", unique = false, nullable = true, insertable = true, updatable = true, length = 1)
