...
function report(reportType){
	if(validate()){
		...
		var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_ContractHistory",predefindedActions.report.toString())%>"+"?PersonnelId="+selected+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="ContractHistory_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
<TABLE  CELLSPACING="1" CELLPADDING="1" width="800" align="center">
     ...
     <tr>
       ...
       <td align="right" class="clsLabel" width="208">
             <%-- <tag:LOV usecaseName="Pr_Bd_Personnel" formClassName="<%=ir.utopia.nejat2.payroll.personnel.action.PersonnelForm.class%>" widgetName="personnelId" searchTitle="personnelSearch" displayItems="name,secound_name,code" separator=" "></tag:LOV>  --%>
