...
<title><%=MessageHandler.getMessage("TakmiliReportTitle",path, lang)%></title>
...
function report(reportType){
	if(validate()){
	    ...
	    var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_TakmiliReport",predefindedActions.report.toString())%>"+"?OrganizationId="+OrganizationId+"&InsuranceType="+InsuranceType+"&MonthCalc="+MonthCalc+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="TakmiliReport_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
