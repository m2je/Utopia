...
<title><%=MessageHandler.getMessage("TaxReportTitle",path, lang)%></title>
...
function report(reportType){
	if(validate()){
	    ...
	    var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_TaxReport",predefindedActions.report.toString())%>"+"?OrganizationId="+OrganizationId+"&HiringType="+HiringType+"&MonthCalc="+MonthCalc+"&PersonnelId="+selected+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="TaxReport_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
