...
if(HiringType == "")
 ...
 String kind = request.getParameter ("kind");
	if (Integer.parseInt (kind)==0){
		...
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/taxReport/taxReport_current&out/TaxReport",result); 	
	}
	
	 if (Integer.parseInt (kind)==1){
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/taxReport/taxReport_current/TaxReport",result); 
		 
	}
	 
	if(Integer.parseInt (kind)==2)
	{
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/taxReport/taxReport_outstanding/TaxReport",result); 
	}
	
 
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/taxReport/TaxReport",result);
%>