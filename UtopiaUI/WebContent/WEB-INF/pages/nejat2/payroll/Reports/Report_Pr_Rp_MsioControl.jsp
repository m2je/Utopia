...
String reportType=  request.getParameter("reportType");
 ...
 String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/msio/msioControl");
...
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/msio/msioControl/MsioControl",result);
%>
