...
/*  String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/payStubs/");
 ...
 objParameters.put("SUBREPORT_DIR", realPath); */
	...
	if (Integer.parseInt (kind)==0){
		 String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_current&out");
		 int index = realPath.lastIndexOf("/");
		 if(index<0){
			index=realPath.lastIndexOf("\\");
			realPath = realPath+ "\\";
		 ...
		 objParameters.put("SUBREPORT_DIR", realPath);
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_current&out/PayStubs",result);
			
	}
	
	 if (Integer.parseInt (kind)==1){
		 String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_current/");
		 int index = realPath.lastIndexOf("/");
		 if(index<0){
			index=realPath.lastIndexOf("\\");
			realPath = realPath+ "\\";
		 ...
		 objParameters.put("SUBREPORT_DIR", realPath);
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_current/PayStubs",result);
		 
	}
	 
	if(Integer.parseInt (kind)==2)
	{
		String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_outstanding/");
		 int index = realPath.lastIndexOf("/");
		 if(index<0){
			index=realPath.lastIndexOf("\\");
			realPath = realPath+ "\\";
		 ...
		 objParameters.put("SUBREPORT_DIR", realPath);	
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/payStubs/payStubs_outstanding/PayStubs",result);
			
	}
	
	
	
/* ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/payStubs/PayStubs",result); */
%>
