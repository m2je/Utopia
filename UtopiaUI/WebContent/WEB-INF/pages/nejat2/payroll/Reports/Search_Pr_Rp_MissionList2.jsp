...
<title><%=MessageHandler.getMessage("MissionList2Title",path, lang)%></title>
...
function report(reportType){
	if(validate()){
	    ...
	    var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_MissionList2",predefindedActions.report.toString())%>"+"?OrganizationId="+OrganizationId+"&MonthCalc="+MonthCalc+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="MissionList2_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
