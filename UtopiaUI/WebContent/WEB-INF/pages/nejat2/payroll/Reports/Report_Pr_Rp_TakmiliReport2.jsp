...
String reportType=  request.getParameter("reportType");
 ...
 objParameters.put("InsuranceType",Integer.parseInt(InsuranceType));
...
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/takmili/TakmiliReport2",result);
%>
