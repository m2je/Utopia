...
String reportType=  request.getParameter("reportType");
 ...
 String kind = request.getParameter ("kind");
	if (Integer.parseInt (kind)==0){
		...
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/tamin/taminReport_current&out/TaminReport",result); 	
	}
	
	 if (Integer.parseInt (kind)==1){
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/tamin/taminReport_current/TaminReport",result); 
		 
	}
	 
	if(Integer.parseInt (kind)==2)
	{
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/tamin/taminReport_outstanding/TaminReport",result); 
	}
	
 
/* ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/tamin/TaminReport",result); */
%>
