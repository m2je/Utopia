...
String reportType=  request.getParameter("reportType");
 ...
 if(DeductionId == "")
		objParameters.put("DeductionId", null);
	else
	{
 List<String> ids = Arrays.asList(DeductionId.split(","));
 Collection<Long> deductionsdefinitionIds = new ArrayList<Long>();
 for(String id:ids){
	 deductionsdefinitionIds.add(Long.parseLong(id));
 }
 
 objParameters.put("DeductionId", deductionsdefinitionIds);
 };
 
 
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/deduction/DeductionList",result);
%>
