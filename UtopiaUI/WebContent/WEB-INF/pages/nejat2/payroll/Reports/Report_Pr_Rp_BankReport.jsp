...
String reportType=  request.getParameter("reportType");
 ...
 if(BranchId == "")
		objParameters.put("BranchId", null);
	else
		objParameters.put("BranchId",Integer.parseInt(BranchId));
...
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/bankReport/BankReport",result);
%>
