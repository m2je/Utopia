...
<title><%=MessageHandler.getMessage("PaymentRequest2Title",path, lang)%></title>
...
function report(reportType){
	if(validate()){
	    ...
	    var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_PaymentRequest2",predefindedActions.report.toString())%>"+"?OrganizationId="+OrganizationId+"&MonthCalc="+MonthCalc+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="PaymentRequest2_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
