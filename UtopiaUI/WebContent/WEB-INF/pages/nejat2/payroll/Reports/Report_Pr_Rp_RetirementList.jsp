...
String reportType=  request.getParameter("reportType");
 ...
 String kind = request.getParameter ("kind");
	if (Integer.parseInt (kind)==0){
		...
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/retirementList/retirement_current&out/RetirementList",result); 	
	}
	
	 if (Integer.parseInt (kind)==1){
		 ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/retirementList/retirement_current/RetirementList",result); 
		 
	}
	 
	if(Integer.parseInt (kind)==2)
	{
		ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/retirementList/retirement_outstanding/RetirementList",result); 
	}
	
 
/* ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/retirementList/RetirementList",result); */
%>
