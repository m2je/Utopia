...
String reportType=  request.getParameter("reportType");
 ...
 String realPath = application.getRealPath("/WEB-INF/reports/nejat2/payroll/taxReport/taxControl");
...
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/taxReport/taxControl/TaxControl",result);
%>
