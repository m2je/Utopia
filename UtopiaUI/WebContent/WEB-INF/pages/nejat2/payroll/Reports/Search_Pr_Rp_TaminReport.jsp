...
<title><%=MessageHandler.getMessage("TaminReportTitle",path, lang)%></title>
...
function report(reportType){
	if(validate()){
	    ...
	    var url = "<%=UsecaseUtil.getActionUrl("Pr_Rp_TaminReport",predefindedActions.report.toString())%>"+"?OrganizationId="+OrganizationId+"&HiringType="+HiringType+"&MonthCalc="+MonthCalc+"&PersonnelId="+selected+"&reportType="+reportType;
		if(url.length == 0){
...
<form name="TaminReport_search" method="POST" target="_self" dir="rtl" action="--WEBBOT-SELF--">
