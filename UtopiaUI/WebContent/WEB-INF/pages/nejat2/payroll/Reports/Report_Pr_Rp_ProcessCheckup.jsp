...
//objParameters.put("code",Integer.parseInt(code));
ReportHelper.runReport(request,response,application,out,objParameters,"payrollResource","/WEB-INF/reports/nejat2/payroll/graphicalReport/ProcessCheckup",result);
%>
