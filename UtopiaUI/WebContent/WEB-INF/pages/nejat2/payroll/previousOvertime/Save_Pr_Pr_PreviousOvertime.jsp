...
String path = "ir.utopia.nejat2.payroll.previousovertime.action.PreviousOvertimeForm";
%>
<script language=javascript>
var personnelError="<%=MessageHandler.getMessage("personnelError",path,lang)%>";
</script>
