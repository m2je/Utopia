...
ReportHelper.runReport(request,response,application,out,objParameters,"creditResource","/WEB-INF/reports/nejat2/credit/CashRequest/ProprietaryCashRequest",result);
%>																		
