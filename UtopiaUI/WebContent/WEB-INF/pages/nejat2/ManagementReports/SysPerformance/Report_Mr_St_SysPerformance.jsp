...
ReportHelper.runReport(request,response,application,out,objParameters,"coreResource","/WEB-INF/reports/nejat2/ManagementReports/SysPerformance/systemperformance",reportType);
%>