...
objParameters.put("chekDate",checkDate);

ReportHelper.runReport(request,response,application,out,objParameters,"accSQLResource","/WEB-INF/reports/nejat2/ManagementReports/Statistical/statistical",reportType);
%>
