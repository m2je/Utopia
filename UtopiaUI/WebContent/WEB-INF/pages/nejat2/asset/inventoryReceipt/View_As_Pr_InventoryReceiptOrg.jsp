...
<%@ page import="ir.utopia.nejat2.asset.inventoryreceipt.action.InventoryReceiptOrgForm"%>
...
<html dir=<%=WebUtil.getDirection(session)%> >
	...
	<%
		String aminDisabled = "";
			...
			String path = "ir.utopia.nejat2.asset.inventoryreceipt.action.InventoryReceiptOrgForm";
	...
	<script type="text/javascript">
		function myFormAction(str){
			switch (str)
			{
				case 'AminConfirm' 	  : document.forms[0].action="AminConfirm_As_Pr_InventoryReceiptOrg.htm";
									 	break;
				case 'AminReject'  	  : document.forms[0].action="AminReject_As_Pr_InventoryReceiptOrg.htm";
									 	break;
				case 'ManagerConfirm' : document.forms[0].action="ManagerConfirm_As_Pr_InventoryReceiptOrg.htm";
										break;
				case 'ManagerReject'  : document.forms[0].action="ManagerReject_As_Pr_InventoryReceiptOrg.htm";
										break;
	...
	<body class="clsInputPage">
		...
		<%
			InventoryReceiptOrgForm form = (InventoryReceiptOrgForm)pageForm.getForm();
		...
		<br/><br/><br/>
			<form name="submitForm" id="submitForm" action="#">
				<input type="hidden" value=<%=request.getParameter("editItem")%> name="receiptDetailId">
