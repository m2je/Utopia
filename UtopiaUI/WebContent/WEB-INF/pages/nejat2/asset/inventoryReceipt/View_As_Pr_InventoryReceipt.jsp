...
<%@ page import="ir.utopia.nejat2.asset.inventoryreceipt.action.InventoryReceiptForm"%>
...
<html dir=<%=WebUtil.getDirection(session)%> >
	...
	<script type="text/javascript">
		function myFormAction(str){
			switch (str)
			{
				case 'AminConfirm' 	  : document.forms[0].action="AminConfirm_As_Pr_InventoryReceipt.htm";
									 	break;
				case 'AminReject'  	  : document.forms[0].action="AminReject_As_Pr_InventoryReceipt.htm";
									 	break;
				case 'ManagerConfirm' : document.forms[0].action="ManagerConfirm_As_Pr_InventoryReceipt.htm";
										break;
				case 'ManagerReject'  : document.forms[0].action="ManagerReject_As_Pr_InventoryReceipt.htm";
										break;
	...
	<body class="clsInputPage">
		...
		<%
			InventoryReceiptForm form = (InventoryReceiptForm)pageForm.getForm();
