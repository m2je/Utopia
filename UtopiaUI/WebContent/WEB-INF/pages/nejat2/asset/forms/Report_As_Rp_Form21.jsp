...
System.out.println("Form21");
String lang =WebUtil.getLanguage(session);

ReportHelper.runReport(request,response,application,out,objParameters,"assetResource","/WEB-INF/reports/nejat2/asset/as_rp_form21");
%>