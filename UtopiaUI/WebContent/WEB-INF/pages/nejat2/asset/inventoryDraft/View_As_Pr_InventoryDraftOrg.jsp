...
<%@ page import="ir.utopia.nejat2.asset.inventorydraft.action.InventoryDraftOrgForm"%>
...
<html dir=<%=WebUtil.getDirection(session)%> >
	...
	<%
		String aminDisabled = "";
			...
			String path = "ir.utopia.nejat2.asset.inventorydraft.action.InventoryDraftOrgForm";
	...
	<body class="clsInputPage">
		...
		<%
			InventoryDraftOrgForm form = (InventoryDraftOrgForm)pageForm.getForm();
