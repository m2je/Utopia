...
String logoURL = WebUtil.getRootAddress(pageContext)+"/images/logos/cheque.jpg";
objParameters.put("logo",logoURL); 


                 
Integer chequeid =Integer.parseInt(request.getParameter("editItem"));

objParameters.put("chequeid",chequeid);


ReportHelper.runReport(request,response,application,out,objParameters,"treasuryResource","/WEB-INF/reports/nejat2/treasury/Cheque",result);
%>
