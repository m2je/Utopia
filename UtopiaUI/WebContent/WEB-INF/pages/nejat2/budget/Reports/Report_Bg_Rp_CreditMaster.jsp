...
<%
	...
	Long creditmasterId = Long.parseLong (request.getParameter ("editItem"));
	objParameters.put ("creditmasterId", creditmasterId);
	...
	ReportHelper.runReport (request, response, application, out, objParameters, "budgetResource",
			"/WEB-INF/reports/nejat2/budget/CreditMaster/CreditMaster", result);
%>
