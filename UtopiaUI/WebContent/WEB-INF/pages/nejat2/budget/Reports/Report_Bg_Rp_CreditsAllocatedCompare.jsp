...
<%
	...
	objParameters.put ("SUBREPORT_DIR",
			application.getRealPath ("/WEB-INF/reports/nejat2/budget/CreditsAllocatedCompare/") + "\\");
	ReportHelper.runReport (request, response, application, out, objParameters, "budgetResource",
			"/WEB-INF/reports/nejat2/budget/CreditsAllocatedCompare/CreditsAllocatCompare", result);
%>
