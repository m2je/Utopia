...
String reportType=  request.getParameter("reportType");
 ...
 String dep_fiscalyear_id = request.getParameter("dep_fiscalyear_id");
 List<String> ids = Arrays.asList(dep_fiscalyear_id.split(","));
 Collection<Long> dep_fiscalyear_ids = new ArrayList<Long>();
 for(String id:ids){
	 dep_fiscalyear_ids.add(Long.parseLong(id));
 }
 objParameters.put("dep_fiscalyear_id",dep_fiscalyear_ids);
 
 
ReportHelper.runReport(request,response,application,out,objParameters,"budgetResource","/WEB-INF/reports/nejat2/budget/AnnounceReports/announce",result);
%>
