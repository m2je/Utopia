...
<%@page import="ir.utopia.nejat2.inventory.buyreqmaster.action.BuyReqMasterForm"%>
...
function myFormAction(str)
{
	...
	if(str=='accept')
		{
         document.forms[0].action="confirm_In_Bd_BuyReqMaster.htm";
 		}
	if(str=='reject')
	    { 
		 document.forms[0].action="reject_In_Bd_BuyReqMaster.htm";
	    }
...
<%
BuyReqMasterForm form = (BuyReqMasterForm)pageForm.getForm();
if(form.getDocStatus()==BRDocStatus.confirmed)
...
%>
       ...
       <br/><br/><br/>
            <form name="submitForm" id="submitForm" action="#">
    	        <input type="hidden" value=<%=request.getParameter("editItem") %> name="reqId">
