...
function myFormAction(str)
{
	...
	if(str=='accept')
		{
         document.forms[0].action="process_In_Pr_AccDocumentMaster.htm";
 		}
	if(str=='reject')
	    { 
		 document.forms[0].action="search_In_Pr_AccDocumentMaster.htm";
	    }
...
<form name="submitForm" id="submitForm" action="#">
    	        <input type="hidden" value=<%=request.getParameter("editItem") %> name="masterId">
