...
Long draftId =Long.parseLong(request.getParameter("editItem"));
objParameters.put("DraftId",draftId);
objParameters.put("logo",logoURL);

ReportHelper.runReport(request,response,application,out,objParameters,"inventoryResource","/WEB-INF/reports/nejat2/inventory/Draft",result);
%>
