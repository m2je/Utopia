...
<meta http-equiv="content-type" content="text/html;charset=UTF-8">
  ...
  <link href="<%=WebUtil.getCss(pageContext,"AccountingTree.css") %>" type="text/css" rel="stylesheet">
	<%if(WebUtil.isRigthToLeft(session)){ 	System.out.print("right"); %>	  
...
<%
String jsfilePath=WebUtil.getJsFile(pageContext,"components/ir.utopia.nejat2.accountsreviewreport.AccountsReviewReport/ir.utopia.nejat2.accountsreviewreport.AccountsReviewReport.nocache.js");
%>
