...
<!-- <script type=\"text/javascript\" language=\"javascript\" src=\""+WebUtil.getJsFile(pageContext,"components/ir.utopia.nejat2.accountingtree.AccountingTree/ir.utopia.nejat2.accountingtree.AccountingTree.nocache.js")+" \"></script>"; -->
<%-- <%@taglib prefix="tag" uri="Util" %>
<tag:TreeForm></tag:TreeForm> --%>
<%
String jsfilePath=WebUtil.getJsFile(pageContext,"components/ir.utopia.nejat2.accountingtree.AccountingTree/ir.utopia.nejat2.accountingtree.AccountingTree.nocache.js");
