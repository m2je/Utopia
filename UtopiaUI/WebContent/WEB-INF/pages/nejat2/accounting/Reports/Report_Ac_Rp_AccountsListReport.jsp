...
ReportHelper.runReport(request,response,application,out,objParameters,"AccountingResource","/WEB-INF/reports/nejat2/accounting/AccountsListReport",reportType);
%>
