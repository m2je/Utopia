...
<%
System.out.print("cccccc "+request.getParameter("editItem")  );
String jsfilePath=WebUtil.getJsFile(pageContext,"components/ir.utopia.nejat2.doctypedimension.DocTypeDimension/ir.utopia.nejat2.doctypedimension.DocTypeDimension.nocache.js");
