...
import ir.utopia.security.OAUTHSecurityProvider;
...
public class LoginBean extends AbstractUtopiaBean implements  LoginBeanRemote {
	private static String login_config = ServiceFactory.getSecurityProvider().getAttributeValue(OAUTHSecurityProvider.LOGIN_CONFIG_NAME);
	String username;
